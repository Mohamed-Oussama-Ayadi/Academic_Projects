<?php
    ...
    if (isset($_POST["id"]) &&
        ...
        {if (!empty($_POST["id"]) && 
            ...
            $boutiqueB->modifier_boutique($boutique, $_POST["id"]);
    ...
    <main class="main-wrap">
        ...
        <section class="content-main" style="max-width: 720px">
            ...
            <div class="content-header">
                <h2 class="content-title">Modifier Boutique</h2>
            </div>
            <div id="error">
                <?php echo $error; ?>
            </div>
            <?php
			if (isset($_POST['id'])){
				$boutique = $boutiqueB->recuperer_boutique($_POST['id']);
		...
		?>
            ...
            <form action="" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="adresse" id="adresse" value="<?php echo $boutique['adresse']; ?>"
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" id="email" value="<?php echo $boutique['email']; ?>" maxlength="30"
                        class="form-control">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nbre_voitures" value="<?php echo $boutique['nbre_voitures']; ?>"
                        id="nbre_voitures" class="form-control">
                </div>

                <div class="mb-4">
                    <label for="nbre_pieces_rechange">Nombre de piéces de rechange:</label>
                    <input type="text" name="nbre_pieces_rechange"
                        value="<?php echo $boutique['nbre_pieces_rechange']; ?>" id="nbre_pieces_rechange"
                        class="form-control">
                </div>
