    ...
    if (
        ...
        {if (
           ...
           //var_dump($_POST["id_produit"]);
            $produitC->modifier_produit( $produit,var_dump($_POST['id_produit']));
    ...
    <main class="main-wrap">
        ...
        <section class="content-main" style="max-width: 720px">
            ...
            <div class="content-header">
                <h2 class="content-title">Modifier Produit</h2>
            </div>
            <div id="error">
                <?php echo $error; ?>
            </div>
			...
			if (isset($_POST['id_produit'])){
				$produit = $produitC->recuperer_produit($_POST['id_produit']);
            ...
            <div class="mb-4">
                    ...
                    <input type="text" name="marque" value="<?php echo $produit['marque']; ?>"  id="marque"
                        maxlength="20" class="form-control">
                </div>

                <div class="mb-4">
                    <label for="photo">photo: </label>
                    <input type="text" name="photo" value="<?php echo $produit['photo']; ?>" id="photo" class="form-control">
                </div>

                <div class="mb-4">
                    <label for="description">description: </label>
                    <input type="text" name="description" value="<?php echo $produit['description']; ?>"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="quantite"  value="<?php echo $produit['quantite']; ?>" id="quantite"
                        class="form-control">
                </div>

                <div class="mb-4">
                    <label for="id_categorie">id_categorie: </label>
                    <input type="text" name="id_categorie"  value="<?php echo $produit['id_categorie']; ?>" id="id_categorie"
                        class="form-control">
                </div>

                <td>
                    <input type="submit" class="btn btn-primary"
                        style="margin-top:3%;margin-left:5%;border-radius: 10%;" name="modifier" value="Modifier">
                </td>
                <td>
                    <input type="reset" class="btn btn-outline-danger"
                        style="margin-top:3%;margin-left:5%;border-radius: 10%;" name="annuler" value="Annuler">
                </td>
