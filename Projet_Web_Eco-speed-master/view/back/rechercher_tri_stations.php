...
$st=new stationController();
$error=null;
/*$id=$_POST['id'];
$critere=$_POST['critere'];*/

if(isset($_POST['boutton_rechercher']))
{
if(isset($_POST['id']))
{
 if(!empty($_POST['id']))
{
$listerecherche=$st->rechercherStationId($_POST['id']);
}
}
else
{
...
if(isset($_POST['boutton_tri']))
{
if(isset($_POST['critere']))
{
 if(!empty($_POST['critere']))
 {
  $listetri=$st->trierStation($_POST['critere']);
 }
}
}
?>
...
<?php echo $error ?>
  ...
  <form action ="" method="POST">
	<div class="card mb-4">
          <div class="card-body">
				<div class="mb-4">
<label for="id" id="id" class="form-label">Identifiant</label>
<input type="text" placeholder="chercher par id" class="form-control" name="id" id="id"/>
<br>
...
<option>Nombre_Voiture</option>
<option>Rentabilite</option>
</select>
<br>
...
?>
<tr>
<td><?php echo $listecritere['id']; ?></td>
<td><?php echo $listecritere['ville']; ?></td>
<td><?php echo $listecritere['energie']; ?></td>
<td><?php echo $listecritere['nombre_voiture']; ?></td>
<td><?php echo $listecritere['rentabilite']; ?></td>
<?php
}
?>
