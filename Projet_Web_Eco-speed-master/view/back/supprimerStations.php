...
if(isset($_POST['reference']))
{
 if(!empty($_POST['reference']))
 {
  ...
  $stationC->supprimerStation($_POST['reference']);
header('Location:afficherStations.php');
 }
	   	else {
...
<section class="content-main" style="max-width: 720px">
	...
	<div class="content-header">
	   <h2 class="content-title">Supprimer Station</h2>
	</div>
<div id="error">
<?php echo $error ?>
</div>
  ...
  <form action ="" method="POST">
	<div class="card mb-4">
          <div class="card-body">
				<div class="mb-4">
					<label for="reference" class="form-label">Identifiant</label>
					<input type="text" placeholder="Tapez l'Identifiant de la Station a supprimer" class="form-control" name="id" id="id">
				</div>

          </div>
    </div> <!-- card end// -->
<input type="submit"  id='boutton_supprimer' name='boutton_supprimer' class="btn btn-primary btn-sm" style="margin-top:3%;margin-left:5%;border-radius: 10%;" value="Supprimer"/>
          </div>
    </div> <!-- card end// -->
</form>
