...
$fac=new facturesC();
$listeFacture=$fac->afficherRefernce();
$listeId=$fac->afficherIdStation();
...
isset($_POST['datepaiement'])
 ...
 !empty($_POST['datepaiement'])
			...
			$facC->modifierFacture($_POST['reference'],$_POST['id_user'],$_POST['matricule'],$_POST['montant'],$_POST['datepaiement']);
...
<section class="content-main" style="max-width: 720px">
	...
	<div class="content-header">
		<h2 class="content-title">Modifier Factures</h2>
	</div>
<div id="error">
<?php echo $error ?>
</div>
  ...
  <form action ="" method="POST">
	<div class="card mb-4">
          <div class="card-body">
					...
					<label for="id_station" class="form-label">Reference: </label>
<br>
<select class="form-select" name="reference" id="reference">
<?php
foreach($listeFacture as $facturel)
{
?>
 <option selected="Identifiant Station"><?php echo $facturel['reference']; ?></option>
<?php
}
?>
</select>
<br>
				<div class="mb-4">
					<label for="matricule" class="form-label">Identifiant Utilisateur</label>
...
<input type="submit"  id='boutton_ajouter' name='boutton_ajouter' class="btn btn-primary" value="Modifier"/>
          </div>
    </div> <!-- card end// -->
</form>
