<?php
    ...
    isset($_POST["email"]))
    { $liste=$ouv->rechercher($_POST["nom"], $_POST["prenom"], $_POST["age"], $_POST["departement"], $_POST["email"]);}
...
<main class="main-wrap">
    ...
    <section class="content-main" style="max-width: 720px">
            ...
            <div class="content-header">
                <h2 class="content-title">Recherche ouvrier</h2>
            </div>
            ...
            <form action="" method="POST" >
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="prenom" id="prenom" maxlength="30" class="form-control">
                </div>
...
<table nom="table_des_ouvriers" id="table_des_ouvriers" class="table align-items-center table-flush">
                                            ...
                                            <?php  foreach($liste as $listeo){ ?>
                                            <tr>
                                                <td><?php echo $listeo['id']; ?></td>
                                                <td><?php echo $listeo['nom']; ?></td>
                                                <td><?php echo $listeo['prenom']; ?></td>
                                                <td><?php echo $listeo['age']; ?></td>
                                                <td><?php echo $listeo['departement']; ?></td>
                                                <td><?php echo $listeo['email']; ?></td>
                                            </tr>
                                            <?php } ?>
                                        </table>
