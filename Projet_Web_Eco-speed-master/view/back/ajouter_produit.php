    ...
    <main class="main-wrap">
        ...
        <section class="content-main" style="max-width: 720px">
            ...
            <div class="content-header">
                <h2 class="content-title">Ajouter produit</h2>
            </div>
            <div id="error">
                <?php echo $error; ?>
            </div>
            ...
            <div class="mb-4">
                    ...
                    <input type="text" name="nom" id="nom" maxlength="100" class="form-control">
                   
                </div>
            
              <div class="mb-4">
                    <label for="marque">marque: </label>
                    <input type="text" name="marque" id="marque" maxlength="20" class="form-control">
                    <p>
                    <div id="errormarque" style="color:red"></div>
                </p>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="description" id="description" cols="80" rows="10" minlength="10" maxlength="500" class="form-control">
                    <p>
                ...
                <div class="mb-4">
                    ...
                    <p>
                    <div id="errorprix" style="color:red"></div>
                </p>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <p>
                    <div id="errorquantite" style="color:red"></div>
                </p>
                </div>
        ...
        var errormarque = document.getElementById('errormarque');
        ...
        if(marque =="")
        {
            errormarque.innerHTML="Oups!La marque est vide!";
            return false;
        }
        
            else
            {
                errormarque.innerHTML="";
            }	
            
        if(description =="")
        {
            errordescription.innerHTML="Oups!La description est vide!";
            return false;
        }
      ...
      if(prix=="")
            {
                errorprix.innerHTML="Le prix est vide!";  
                return false;
            }
            else 
                if(prix<= 0)
                {
                    errorprix.innerHTML="le prix doit etre superieure à 0 !";  
                    return false;
                }
                else
                {
            ...
            if(quantite=="")
            {
                errorquantite.innerHTML="La quantite est vide!";  
                return false;
            }
            else 
                if(quantite<0)
                {
                    errorquantite.innerHTML="La quantite doit etre superieur à 0 !";  
                    return false;
                }
                else
                {
