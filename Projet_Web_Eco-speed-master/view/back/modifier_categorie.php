<?php
     ...
     if (
         ...
         {if (
             ...
             $categorieC->modifier_categorie($categorie, $_POST["id_categorie"]);
    ...
    <main class="main-wrap">
        ...
        <section class="content-main" style="max-width: 720px">
            ...
            <div class="content-header">
                <h2 class="content-title">Modifier Categorie</h2>
            </div>
            <div id="error">
                <?php echo $error; ?>
            </div>
			...
			if (isset($_POST["id_categorie"])){
				$categorie = $categorieC->recuperer_categorie($_POST["id_categorie"]);
			?>
            ...
            <div class="mb-4">
                    ...
                    <input type="text" name="nom"  value="<?php echo $categorie['nom']; ?>" id="nom"
            ...
            <div class="mb-4">
                    ...
                    <input type="text" name="type" value="<?php echo $categorie['type']; ?> "  id="type"
                        maxlength="20" class="form-control">
                </div>

                <div class="mb-4">
                    <label for="stock_max">stock_max: </label>
                    <input type="text" name="stock_max" value="<?php echo $categorie['stock_max']; ?>" id="stock_max" class="form-control">
                </div>
