...
$listeStation=$st->afficherStation();
...
<?php
foreach($listeStation as $stationListe)
{
?>
<tr>
<td><?php echo $stationListe['id']; ?></td>
<td><?php echo $stationListe['ville']; ?></td>
<td><?php echo $stationListe['energie']; ?></td>
<td><?php echo $stationListe['nombre_voiture']; ?></td>
<td><?php echo $stationListe['rentabilite']; ?></td>
<?php
}
?>
