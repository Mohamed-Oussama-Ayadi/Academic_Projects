<?php
    ...
    { $liste=$bou->rechercher($_POST["adresse"], $_POST["email"], $_POST["nbre_voitures"], $_POST["nbre_pieces_rechange"]);}
...
<main class="main-wrap">
    ...
    <section class="content-main" style="max-width: 720px">
            ...
            <div class="content-header">
                <h2 class="content-title">Recherche Boutique</h2>
            </div>
            ...
            <form action="" method="POST" >
                ...
                <td>
                    <input type="submit" class="btn btn-primary btn-sm"
                        style="margin-top:3%;margin-left:5%;border-radius: 10%;" nom="rechercher" value="rechercher">
                </td>
                <td>
...
<table nom="table_des_boutiques" id="table_des_boutiques" class="table align-items-center table-flush">
                                            <tr>
                                                ...
                                                <th>Nombre de pieces de rechange</th>
                                                
                                            </tr>
                                            <?php  foreach($liste as $listeb){ ?>
                                            <tr>
                                                <td><?php echo $listeb['id']; ?></td>
                                                <td><?php echo $listeb['adresse']; ?></td>
                                                <td><?php echo $listeb['email']; ?></td>
                                                <td><?php echo $listeb['nbre_voitures']; ?></td>
                                                <td><?php echo $listeb['nbre_pieces_rechange']; ?></td>
                                            </tr>
                                            <?php } ?>
                                        </table>
