<?php
	...
	$listeBoutique=$boutiqueB->afficher_boutique(); 
?>
...
<head>
    ...
    <script type="text/javascript" src="fichier_excel_boutiques.js"></script>
                            ...
                            <div id="pay-invoice">
                                <div class="card-body">
                                    <div class="card-title">
                                        ...
                                        <br>
                                        <br>
                                        <table nom="table_des_boutiques" id="table_des_boutiques" class="table align-items-center table-flush">
                                            <tr>
                                                <th>Id</th>
                                                <th>Adresse</th>
                                                <th>Email</th>
                                                <th>Nombre de voitures</th>
                                                <th>Nombres de pieces de rechange</th>
                                                <th>Modifier</th>
                                                <th>Supprimer</th>
                                            </tr>
                                            <?php  foreach($listeBoutique as $boutique){ ?>
                                            <tr>
                                                <td><?php echo $boutique['id']; ?></td>
                                                <td><?php echo $boutique['adresse']; ?></td>
                                                <td><?php echo $boutique['email']; ?></td>
                                                <td><?php echo $boutique['nbre_voitures']; ?></td>
                                                <td><?php echo $boutique['nbre_pieces_rechange']; ?></td>
                                                <td>
                                                    <form method="POST" action="modifier_boutique.php">
                                                        <input type="submit" name="Modifier"
                                                            ...
                                                            value="Modifier">
                                                        <input type="hidden" value=<?PHP echo $boutique['id']; ?>
                                                        name="id">
                                                    </form>
                                                </td>
                                                <td>
                                                    <form method="POST" action="supprimer_boutique.php">
                                        ...
                                        <div>
                                        <button onclick="ExportToExcel(table_des_boutiques)" class="btn btn-primary" style="margin-top:3%;margin-left:5%;border-radius: 10%;" id="excel">
                                         Excel </button>
