...
$query=$con->query("SELECT ville as ville_amount , sum(rentabilite) as amount from station group by ville_amount");
...
<input type="submit" class="btn btn-primary" value="Energie Consommee par ville" onclick="window.open('../View/statistiques_station2.php','New Page');"/>
<br>
<br>
<input type="submit" class="btn btn-primary" value="Villes Plus Rentables" onclick="window.open('../View/statistiques_station3.php','New Page');"/>
