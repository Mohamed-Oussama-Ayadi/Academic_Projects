<?php
require_once '../../controller/stationsController.php';

$stationC = new stationController();
$listeStation=$stationC->afficherStation();
?>
...
<main class="main-wrap">
    ...
    <section class="content-main">
        ...
        <div class="content-header">
            <h2 class="content-title">Table des Stations</h2>
        </div>
            <div class="card-body">
...
<caption>Liste des Facturs</caption>
                    <thead>
                        <tr>
                            ...
                            <th>Rentabilite en (%</th>
                        </tr>

<?php
foreach($listeStation as $liste)
{
?>
<tr>
<td><?php echo $liste['ville']; ?> </td>
<td><?php echo $liste['energie']; ?></td>
<td><?php echo $liste['nombre_voiture']; ?></td>
<td><?php echo $liste['rentabilite']; ?></td>
<td><input type="submit" class="btn btn-primary"  id='boutton_ajouter' name='boutton_ajouter' value="Afficher Totalite" onclick="window.open('../../view/back/afficherTotaliteStation.php','New Page');"/></td>
<td><input type="submit" class="btn btn-primary"  id='boutton_modifier' name='boutton_modifer' value="Modifier" onclick="window.open('../../view/back/modifierStations.php','New Page');" /></td>
<td><input type="submit" class="btn btn-primary"  id='boutton_supprimer' name='boutton_supprimer' value="Supprimer" onclick="window.open('../../view/back/supprimerStations.php','New Page');"/></td>
<?php
}
?>
