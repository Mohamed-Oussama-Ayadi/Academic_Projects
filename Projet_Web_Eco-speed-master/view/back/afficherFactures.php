<?php
require_once '../../controller/facturesController.php';
include_once '../../controller/error.php';

$fac=new facturesC();
$listeFacture=$fac->afficherFactures();

if (isset($_POST['boutton_pdf']))
{
 $fac->generatePDF();
}
...
<main class="main-wrap">
    ...
    <section class="content-main">
        ...
        <div class="content-header">
            <h2 class="content-title">Table des factures</h2>
            <div>
...
<caption>Liste des Facturs</caption>
                    <thead>
                        <tr>
                            <th>ID Utilsateur</th>
                            <th>Matricule</th>
...
?>
<tr>
<td><?php echo $facturel['id_user']; ?></td>
<td><?php echo $facturel['matricule']; ?></td>
<td><?php echo $facturel['montant']; ?></td>
<td><?php echo $facturel['date_paiement']; ?></td>
<td><input type="submit" class="btn btn-primary"   id='boutton_ajouter' name='boutton_ajouter' value="Afficher Totalite" onclick="window.open('../View/afficherTotalite.php','New Page');" /></td>
<td><input type="submit" class="btn btn-primary"  id='boutton_modifier' name='boutton_modifier' value="Modifier" onclick="window.open('../View/modifierFactures.php','New Page');" /></td>
<td><input type="submit" class="btn btn-primary"  id='boutton_supprimer' name='boutton_supprimer' value="Supprimer" onclick="window.open('../View/supprimerFactures.php','New Page');"/></td>
<?php
}
?>
                </div> <!-- table-responsive end // -->

<input  type="submit" class="btn btn-primary" id="boutton_pdf" name="boutton_pdf" value="Generate PDf"  />
