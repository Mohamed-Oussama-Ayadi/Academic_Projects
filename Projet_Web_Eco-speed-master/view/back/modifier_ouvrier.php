<?php
    ...
    if (isset($_POST["id"]) &&
        ...
        {if (!empty($_POST["id"]) && 
            ...
            $_POST['departement'],
            $_POST['email']);
            $ouvrierO->modifier_ouvrier($ouvrier, $_POST["id"]);
    ...
    <main class="main-wrap">
        ...
        <section class="content-main" style="max-width: 720px">
            ...
            <div class="content-header">
                <h2 class="content-title">Modifier Ouvrier</h2>
            </div>
            <div id="error">
                <?php echo $error; ?>
            </div>
            ...
            <?php
			if (isset($_POST['id'])){
				$ouvrier = $ouvrierO->recuperer_ouvrier($_POST['id']);
			?>
            ...
            <form action="" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nom" id="nom" value="<?php echo $ouvrier['nom']; ?>" maxlength="20"
                        class="form-control">
                </div>

                <div class="mb-4">
                    <label for="prenom">Prenom: </label>
                    <input type="text" name="prenom" id="prenom" value="<?php echo $ouvrier['prenom']; ?>"
                        maxlength="20" class="form-control">
                </div>

                <div class="mb-4">
                    <label for="age">Age: </label>
                    <input type="text" name="age" value="<?php echo $ouvrier['age']; ?>" id="age" class="form-control">
                </div>

                <div class="mb-4">
                    <label for="departement">Departement: </label>
                    <input type="text" name="departement" value="<?php echo $ouvrier['departement']; ?>"
                        id="departement" class="form-control">
                </div>

                <div class="mb-4">
                    <label for="email">Email: </label>
                    <input type="email" name="email" id="email" value="<?php echo $ouvrier['email']; ?>"
                        class="form-control">
                </div>
