...
if(isset($_POST['reference']))
{
 ...
 {
$facC = new facturesC();
$facC->supprimerFacture($_POST['reference']);
...
<section class="content-main" style="max-width: 720px">
	...
	<div class="content-header">
	   <h2 class="content-title">Supprimer Factures</h2>
		<div>
...
{
?>
 <option selected="Reference Facture"><?php echo $liste['reference']; ?></option>
<?php
}
?>
</select>
...
<input type="submit"  id='boutton_supprimer' name='boutton_supprimer' class="btn btn-primary" value="Supprimer"/>
          </div>
    </div> <!-- card end// -->
</form>
