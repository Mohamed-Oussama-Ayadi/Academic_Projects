...
if (isset($_POST['email'])) {
    ...
    $UtilisateursU->resetPassword($email_user,md5($newPass));
...
<body>
    ...
    <form method="POST" action="">
      ...
      <div class="textbox"> 
        ...
        <input type="email" id="pwd" placeholder="email" name="email" value="">
    </div>
    <br>

    <div>
         <input class="btn" type="submit" value="reset password"/> </a>
    </div>
    </form>
    <br><br>
</body>